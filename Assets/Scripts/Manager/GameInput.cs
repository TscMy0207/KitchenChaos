...
public class GameInput : MonoBehaviour
{
    ...
    public event EventHandler OnInteracterAction;

    public event EventHandler OnInteracterAlternate;
    ...
    {
        OnInteracterAlternate?.Invoke(this, EventArgs.Empty);
    }

    private void Interact_performed(UnityEngine.InputSystem.InputAction.CallbackContext obj)
    {
        OnInteracterAction?.Invoke(this, EventArgs.Empty);
    }
