            ...
            switch (state.Value) {
                ...
                case State.Frying:
                    ...
                    if (fryingTimer.Value > fryingRecipeSO.fryingTimerMax) {
                        ...
                        SetBuringRecipeSOClientRpc(KitchenGameMutiplayer.Instance.GetKitchenObjectSOIndex(GetKitchenObject().GetKitchenObjectSO()));
        ...
        if (!HasKitchenObject()) {
            ...
            if (player.HasKitchenObject()) {
                if (HasRecipeWithInput(player.GetKitchenObject().GetKitchenObjectSO())) {
                    ...
                    InteractLogicPlaceObjectOnCounterServerRpc(KitchenGameMutiplayer.Instance.GetKitchenObjectSOIndex(kitchenObject.GetKitchenObjectSO()));
                }
            } else {
            }
        } else {
